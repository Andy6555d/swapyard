  ...
  return (
    <div className="wrap page">
      <div className="legal-page">
        ...
        <h2>Eligibility</h2>
        <p>
          Access is limited to independent merchant outlets. By registering, you confirm the
          details you provide are accurate and that you have the authority to list stock on
        ...
        <p>
          ...
          under your account. Let us know if you believe your account has been accessed without
          authorization.
        </p>
        ...
        <ul>
          <li>List anything illegal, unsafe, or that you don&apos;t have the right to sell</li>
        ...
        <h2>Your content</h2>
        <p>
          You keep ownership of the photos and descriptions you post. By posting them, you give
          SwapYard permission to display them on the platform for other outlets to view.
        </p>

        <h2>Suspension and removal</h2>
        <p>
          We may suspend or remove an account or listing that breaches these terms, misuses the
